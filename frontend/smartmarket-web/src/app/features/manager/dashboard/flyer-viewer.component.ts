...
export class FlyerViewerComponent implements OnInit {
  ...
  private carregarDadosComplementares(encarte: EncarteDigitalResponse): void {
    ...
    forkJoin(requests).subscribe({
      next: (res: any) => {
        ...
        const supers = ofertasDoEncarte.filter((o: OfertaSupermercado) => o.superOferta);
        const normals = ofertasDoEncarte.filter((o: OfertaSupermercado) => !o.superOferta);
  ...
  private carregarMock(): void {
    ...
    const mockList: any[] = [
      { id: 'o1', nomeProduto: 'Arroz Agulhinha Tipo 1 - 5kg', preco: 29.90, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o2', nomeProduto: 'Feijão Carioca Kicaldo - 1kg', preco: 8.45, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1551462147-37885acc3c41?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o3', nomeProduto: 'Óleo de Soja Liza - 900ml', preco: 6.89, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o4', nomeProduto: 'Café Melitta Vácuo - 500g', preco: 18.90, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o5', nomeProduto: 'Leite Integral Italac - 1L', preco: 4.59, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1563636619-e9107daaf021?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o6', nomeProduto: 'Detergente Ipê Neutro - 500ml', preco: 2.25, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1584622781564-1d9876a13d1e?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o7', nomeProduto: 'Picanha Bovina Fatiada (kg)', preco: 69.90, unidadeMedida: 'KG', urlImagem: 'https://images.unsplash.com/photo-1558030006-45c675171f65?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o8', nomeProduto: 'Cerveja Heineken Long Neck 330ml', preco: 6.49, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1618885472179-5e474019f2a9?q=80&w=200&auto=format&fit=crop', superOferta: true },
      { id: 'o9', nomeProduto: 'Banana Prata Premium (kg)', preco: 5.98, unidadeMedida: 'KG', urlImagem: 'https://images.unsplash.com/photo-1571771894821-ad9902d83f4e?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o10', nomeProduto: 'Açúcar Cristal Delta - 5kg', preco: 16.90, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1581441363689-1f3c3c414635?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o11', nomeProduto: 'Sabão em Pó Omo 1.6kg', preco: 24.90, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1605648916361-9bc12ad6a569?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o12', nomeProduto: 'Papel Higiênico Neve 12 rolos', preco: 19.90, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o13', nomeProduto: 'Maionese Hellmanns 500g', preco: 11.45, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1585325701166-38209ef8a191?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o14', nomeProduto: 'Refrigerante Coca-Cola 2L', preco: 9.90, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1622708782596-13d9744f9900?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o15', nomeProduto: 'Biscoito Recheado Passatempo', preco: 2.99, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1558961312-5034fab3930e?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o16', nomeProduto: 'Coração de Frango (kg)', preco: 22.90, unidadeMedida: 'KG', urlImagem: 'https://images.unsplash.com/photo-1606411594919-482466d97e20?q=80&w=200&auto=format&fit=crop', superOferta: true },
      { id: 'o17', nomeProduto: 'Tomate Italiano (kg)', preco: 7.45, unidadeMedida: 'KG', urlImagem: 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o18', nomeProduto: 'Vinho Tinto Chileno 750ml', preco: 39.90, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o19', nomeProduto: 'Shampoo Dove 400ml', preco: 18.50, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1535585209827-a15fcdbc4c2d?q=80&w=200&auto=format&fit=crop', superOferta: false },
      { id: 'o20', nomeProduto: 'Sabonete Rexona 84g', preco: 2.15, unidadeMedida: 'UN', urlImagem: 'https://images.unsplash.com/photo-1610555356070-d0efb6505f81?q=80&w=200&auto=format&fit=crop', superOferta: false }
    ];

    // Misturar também o Mock para demonstração de alta fidelidade
    const supersM = mockList.filter((o: any) => o.superOferta);
    const normalsM = mockList.filter((o: any) => !o.superOferta);
    const misturadasM: OfertaSupermercado[] = [];
    let superIdxM = 0;
    let normalIdxM = 0;
    
    while (superIdxM < supersM.length || normalIdxM < normalsM.length) {
      if (superIdxM < supersM.length) {
        misturadasM.push(supersM[superIdxM++]);
      }
      for (let i = 0; i < 3 && normalIdxM < normalsM.length; i++) {
        misturadasM.push(normalsM[normalIdxM++]);
      }
    }

    this.ofertas.set(misturadasM as any);
